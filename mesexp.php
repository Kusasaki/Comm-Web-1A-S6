            ...
            <div>
                <?php
                    ...
                    { ?> <div class="cadre"> <p class="titre_page">Expérience : </p> <?php
                        ...
                        <form  name="modifierexp" action="modifierexp.php?idm= <?php echo $ligne['id_exppro']?>" method="post"><button type="submit">Modifier l'expérience</button></form></form><br/>

                        <form  name="supexp" action="supexp.php?ids= <?php echo $ligne['id_exppro']?>" method="post"><button type="submit">Supprimer l'expérience</button></form></form>
                        <br/>
