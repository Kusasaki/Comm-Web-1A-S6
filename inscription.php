...
include_once "includes/functions.php";
    ...
    if (isset($_POST['nom'])) {
        ...
        values (?,?,?,?)');
        $addacces->execute(array($mail, $mdp, $idel, $idg));
...
<html>
    <body>
        ...
        <form method="POST" action="inscription.php" role="form">
            ...
            <p><input type="text" name="nom" id="nom" placeholder="Nom" size="30" maxlength="30" /></p>

            <p><input type="text" name="prenom" id="prenom" placeholder="Prénom" size="30" maxlength="30" /></p>

            <p><input type="text" name="dateNaissance" id="da" placeholder="AAAA-MM-JJ" size="30" maxlength="30" /></p>

            <p><input type="text" name="promotion" id="promo" placeholder="AAAA" size="30" maxlength="4" /></p>
            ...
            <p><input type="text" name="mdp" id="mdp" placeholder="Mot de passe" size="30" maxlength="50" /></p>
            <p><input type="text" name="mdpbis" id="mdpbis" placeholder="Confirmez le mot de passe" size="30" maxlength="50" /></p> </fieldset>
